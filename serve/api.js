...
router.post('/api/main/contentOne', function (req, res) {
    db.Content.findOne({_id:req.body.diameter}).then((contents)=> {
...
router.get('/api/main/dn', function (req, res) {
    db.Content.find({},{"diameter": 1}).then((contents)=> {
        responseData.data = contents;
        responseData.message='获取成功';
        res.json(responseData);
    })
})
router.post('/api/main/addData', function (req, res) {
    new db.Content({
        diameter: req.body.diameter,
        allowLoad: req.body.allowLoad,
        supportH: req.body.supportH,
        baseplate:{
            l1:req.body.baseplate.l1,
            b1:req.body.baseplate.b1,
            δ1:req.body.baseplate.δ1
        },
        abdomenBoard:req.body.abdomenBoard,
        hellsplate:{
            l3:req.body.hellsplate.l3,
            b2:req.body.hellsplate.b2,
            b3:req.body.hellsplate.b3,
            δ3:req.body.hellsplate.δ3
        },
        underboard:{
            arcLength:req.body.underboard.arcLength,
            b4:req.body.underboard.b4,
            δ4:req.body.underboard.δ4,
            e:req.body.underboard.e
        },
        //关联字段螺栓间距
        boltgap:{
            l2:req.body.boltgap.l2,
            d:req.body.boltgap.d,
            m:req.body.boltgap.m,
            l:req.body.boltgap.l
        },
        supportWeight:req.body.supportWeight,
        addHeight:req.body.addHeight
    }).save().then((data)=>{
        if(data!==null){
...
router.post('/api/main/delData', function (req, res) {
    db.Content.remove({
        _id:req.body.id
    }).then(function(){
        db.Content.find().then((newUser)=>{
